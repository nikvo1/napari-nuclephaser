...
def predict_on_two_stack(
    ...
    """Takes a 2-dimensional stack of images (grayscale of RGB), YOLO object detection model (v5, v8 or v11) and SAHI parameters ->
    returns a detection in formats of two-dimensional stack of Points layers and saves count results in .csv/.xlsx format and metadata in .txt format
